...
8. Type your username & passowrd than save - username and password are stored in the local storage - (if you clear the broweser cache the login will be deleted and you will need to type it again)
9. Click on Save
